...
class UsersClubController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('users_club.index')->with('posts',$posts);
    }
    /**
    ...
    public function show($id)
    {
        ...
        return view('users_club.show')->with('post',$post);
    }
    ...
    {
        $post = UserClub::where('club_id',auth()->user()->club_id)->take(1)->find($id);
        return view('users_club.edit')->with('post',$post);
    }
